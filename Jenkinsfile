        ...
        stage('Instumental tests') {
            ...
            post {
                always {
                    ...
                    //junit '${env.WORKSPACE}/app/build/reports/androidTests/connected/*.xml'
                    sh "cp -r app/build/reports/androidTests/connected/ ${env.WORKSPACE}/"
                    sh "ls app/build/reports/androidTests/connected"
                    junit allowEmptyResults: true, testResults: 'app/build/reports/androidTests/connected/*.xml'
